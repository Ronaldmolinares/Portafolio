...
export const OTHER_PROJECTS: Project[] = [
    ...
    ,
    {
        ...
        year: '2025',
        shortDescription: 'Aplicación CLI para cifrar y descifrar texto mediante los algoritmos César y Vigenère, diseñada con una arquitectura modular y validaciones robustas para facilitar el aprendizaje de conceptos fundamentales de criptografía.',
