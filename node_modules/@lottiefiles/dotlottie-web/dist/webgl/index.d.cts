...
declare class DotLottie {
   ...
   * @returns true if successful
   */
  setImageSlot(slotId: string, src: string): Promise<boolean>;
  /**
   ...
   */
  stateMachineSetSeed(seed: number): boolean;
  /**
   * @experimental
...
//#endregion
//#region src/webgl/dotlottie-webgl.d.ts
declare class DotLottieWebGL extends DotLottie {
